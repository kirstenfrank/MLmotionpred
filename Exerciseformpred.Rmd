...
```{r exploratory graphs,cache=TRUE}
...
```{r Preditor influence, cache=TRUE}
influence<-varImp(randforestfit)
table<-influence[1]
```

The 5 most important predictors are `r influence[1]`, `r influence[2]`, 
